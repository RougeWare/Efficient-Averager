 ...
 * This file is 3,686 Bytes, and eff-avg.js is only 247 Bytes.
 */
 ...
 * @version 1.2.0
 * 		- 2014-08-10 (1.2.0) - Ky moved "return" to top, removed" self" entirely
 * 		- 2014-04-12 (1.1.1) - Ky improved documentation
 * 		- 2014-04-09 (1.1.0) - Ky added current() and count() methods to reliably access variables
 * 		- 2014-04-09 (1.0.0) - Ky made base code
 */
...
var Averager = function(startingNumber)
{
	...
	return {
		 ...
		 * @since 2014-04-09
		 * @version 1.0.0
		 * 		- 2014-04-09 (1.0.0) - Ky added to reliably access the current average, even in minified code
		 */
		current : function()
		{
		 ...
		 * @since 2014-04-09
		 * @version 1.0.0
		 * 		- 2014-04-09 (1.0.0) - Ky added to reliably access the average counter, even in minified code
		 */
		count : function()
		{
